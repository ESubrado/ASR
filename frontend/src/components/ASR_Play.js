  ...
  return (
    <div className="container mx-auto py-12">
      ...
      <div className="flex flex-col md:flex-row justify-center space-y-4 md:space-y-0 md:space-x-8 mt-2">
        <TimeCatcher id="start-time" label="Start Time:" value={startTime} onChange={handleStartTimeChange} maxDuration={audioDuration || Infinity} />
        <TimeCatcher id="end-time" label="End Time:" value={endTime} onChange={setEndTime} maxDuration={audioDuration || Infinity} />
      </div>
